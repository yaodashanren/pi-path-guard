...
import { type CmdInfo, type RedirectTarget, extractCommandSubstitutions, extractHeredocs, extractPathArgs, extractRedirectTarget, findMatchingParen, hasForceFlag, hasLongFlag, hasShortFlag, isDeleteCommand, isQuotedAt, isTruncatingOp, lastDestArg, parseCommand, replaceLeadingSubstitutionCommand, splitSegments, splitShellTokens, stripPrefixTokens } from "./shell-parse.ts";
import { type SegmentVerdict, classifySegment, classifySegmentOuter, classifySubstitutions, curlDownloadTarget, dangerousLevel, downloadTarget, inputRedirectTarget, judgeDd, judgeDelete, judgeDownload, judgeGit, judgeInPlace, judgeInputRedirect, judgeOverwrite, judgeScript, judgeScriptTargetPath, judgeShellWrapper, judgeTruncate, judgeUnresolvedRedirectTarget, judgeUnresolvedScriptTarget, judgeWriters, outsideWriteVerdict, pipeGroups, pipeSourceIsExternal, protectedVerdict, scanPipeToShell, scriptTargetOf, tailLooksUserProtected, tarIsExtraction, unresolvedScriptTail, unresolvedTargetVerdict, unwrapShellWrapper, wgetDownloadTarget } from "./judges.ts";
